		...
		<>
			...
			<div className='p-2 md:p-4 relative'>
				...
				>
					...
					<div className='flex flex-col md:flex-row mb-4 items-start md:items-center justify-between gap-4'>
						...
						<div className='flex items-center gap-3 w-full md:w-auto flex-1 justify-end'>
							...
							{/* 商店列表源简易卡片 */}
							<div
								className='hidden sm:flex items-center gap-2 bg-default-100/50 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/20 dark:border-white/10'>
								<span
									className='text-xs text-default-500 whitespace-nowrap'>源: {getStoreSourceDisplayName()}</span>
				...
				<div className='relative'>
					...
					{loading && (
						<div
							className='absolute inset-0 bg-zinc-500/10 z-30 flex justify-center items-center backdrop-blur-sm rounded-lg'>
							<Spinner size='lg'/>
						</div>
					)}
					...
					<div
						className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 justify-start items-stretch gap-4'>
			...
			{installProgress.show && (
				<div
					className='fixed inset-0 flex items-center justify-center z-[9999] animate-in fade-in duration-300'>
					{/* 毛玻璃背景层 */}
					...
					>
						...
						<div className='flex flex-col gap-4'>
							...
							<div className='flex items-center justify-between'>
								...
								<span
									className='text-2xl font-black text-primary font-mono'>{Math.round(installProgress.progress)}%</span>
							</div>

							{/* 进度条 */}
							<div
								className='w-full bg-default-200/50 dark:bg-default-100/20 rounded-full h-4 overflow-hidden border border-default-300/20 dark:border-white/5'>
								<div
							...
							{/* 详细数据 (大小) - 始终显示 */}
							<div
								className='flex items-center justify-between text-xs text-default-400 font-bold tracking-tight'>
