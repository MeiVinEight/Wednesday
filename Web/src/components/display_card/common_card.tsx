					...
					if (targetFullField)
					{
						...
						return (
							<>
								...
								>
									<span
										className='text-xs text-default-500 dark:text-white/50 font-medium tracking-wide'>类型</span>
								...
								>
									<span
										className='text-xs text-default-500 dark:text-white/50 font-medium tracking-wide'>{targetFullField.label}</span>
									<div className='text-sm font-medium text-default-700 dark:text-white/90 truncate'>
						...
						return (
							<>
								...
								{displayFields.map((field, index) => (
									...
									>
										<span
											className='text-xs text-default-500 dark:text-white/50 font-medium tracking-wide'>{field.label}</span>
										<div
											className='text-sm font-medium text-default-700 dark:text-white/90 truncate'>
											{field.render
												? (
