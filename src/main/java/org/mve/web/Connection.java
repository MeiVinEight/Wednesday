...
public class Connection
{
	...
	public Connection(String name, String url, String token)
	{
		this(null, name, url, token);
	}

	public Connection(Integer id, String name, String url, String token)
	{
		this.ID = id;
		this.NAME = name;
		this.URL = url;
