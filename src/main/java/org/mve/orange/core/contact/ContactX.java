...
public abstract class ContactX implements Contact
{
	public final Bot context;
	public final long ID;

	public ContactX(Bot context, long id)
	{
	...
	{
		return (MessageReceipt<?>) this.sendMessage(s, Mirroring.checkcast(Orange.CONTINUATION));
	}
