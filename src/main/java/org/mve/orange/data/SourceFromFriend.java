...
public class SourceFromFriend extends OnlineMessageSource.Incoming.FromFriend
{
	...
	public SourceFromFriend(Orange context, String raw)
	{
		this.context = context;
		this.raw = raw;
		this.data = new LazyJVM<>(() -> Json.resolve(SourceFromFriend.this.raw));
		this.sender = new LazyJVM<>(() -> this.context.getFriend(this.data.getValue().get(OrangeAPI.KEY_SENDER).number(OrangeAPI.KEY_USER_ID).longValue()));
